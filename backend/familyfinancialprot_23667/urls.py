"""familyfinancialprot_23667 URL Configuration
...
admin.site.site_header = "FamilyFinancialProtection"
admin.site.site_title = "FamilyFinancialProtection Admin Portal"
admin.site.index_title = "FamilyFinancialProtection Admin"

# swagger
api_info = openapi.Info(
    title="FamilyFinancialProtection API",
    default_version="v1",
    description="API documentation for FamilyFinancialProtection App",
)
